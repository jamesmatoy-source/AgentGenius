    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-black text-white h-24 flex items-center border-b-4 border-enterprise-purple shadow-lg">
      <div className="w-full px-6 lg:px-16 flex items-center justify-between h-full">
        ...
        <nav className="hidden xl:flex items-center h-full ml-auto">
          <button
            onClick={() => handleNavClick('home')}
            className={`relative h-full flex items-center px-5 text-sm font-bold transition-colors uppercase tracking-wider whitespace-nowrap group ${currentPage === 'home' ? 'text-enterprise-purple bg-zinc-900' : 'text-white hover:bg-zinc-900'}`}
          >
            Home
          ...
          <button
            ...
            className="relative h-full flex items-center px-5 text-sm font-bold text-white hover:bg-zinc-900 transition-colors uppercase tracking-wider whitespace-nowrap group"
          >
            Who We Help
          ...
          <button
            ...
            className={`relative h-full flex items-center px-5 text-sm font-bold transition-colors uppercase tracking-wider whitespace-nowrap group ${currentPage === 'principles' ? 'text-enterprise-purple bg-zinc-900' : 'text-white hover:bg-zinc-900'}`}
          >
            Responsible AI
          ...
          <button
            ...
            className={`relative h-full flex items-center px-5 text-sm font-bold transition-colors uppercase tracking-wider whitespace-nowrap group ${currentPage === 'blog' ? 'text-enterprise-purple bg-zinc-900' : 'text-white hover:bg-zinc-900'}`}
          >
            Blog
